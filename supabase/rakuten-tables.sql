...
CREATE TABLE IF NOT EXISTS rakuten_products (
  ...
  name TEXT NOT NULL,
  product_id TEXT NOT NULL UNIQUE, -- 商品管理番号
  sku TEXT,
  selling_price NUMERIC NOT NULL DEFAULT 0,
  cost_price NUMERIC NOT NULL DEFAULT 0,
  fee_rate NUMERIC NOT NULL DEFAULT 10, -- 楽天手数料率(%)
  category TEXT,
  product_group TEXT,
...
-- RLS (Row Level Security) - disable for simplicity (same as existing tables)
...
-- Allow all operations (matching existing policy pattern)
